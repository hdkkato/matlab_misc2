...
%      applied to the GUI before pca_dialog_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to pca_dialog_OpeningFcn via varargin.
%
...
% Last Modified by GUIDE v2.5 08-Jul-2013 10:08:34
...
function maxpcnumbers_Callback(hObject, eventdata, handles)
% hObject    handle to maxpcnumbers (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% Hints: get(hObject,'String') returns contents of maxpcnumbers as text
%        str2double(get(hObject,'String')) returns contents of maxpcnumbers as a double


% --- Executes during object creation, after setting all properties.
function maxpcnumbers_CreateFcn(hObject, eventdata, handles)
% hObject    handle to maxpcnumbers (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
...
uiresume(handles.sgder2_dialog);
