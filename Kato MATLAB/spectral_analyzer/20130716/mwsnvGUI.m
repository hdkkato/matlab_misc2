...
xlabel(handles.preview_axes, 'abscissa axis')
ylabel(handles.preview_axes, 'longitudinal axis')
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
dialog_plsr(handles.label, handles.sepwave, snv(handles.sepspec), handles.ref, handles.fmax);